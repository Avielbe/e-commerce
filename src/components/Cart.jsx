...
const Cart = () => {
  ...
  return (
    <div className="fixed left-0 top-28 h-screen w-1/5 bg-white shadow-xl shadow-gray-400 overflow-y-auto">
      <h2 className="text-xl font-bold mb-4 text-right px-4 pt-4">עגלת קניות</h2>
      <div className="px-4">
        {cartItems.map((item) => (
      ...
      <div className="mt-4 border-t-2 border-gray-300 pt-4 px-4">
        ...
        <div className="flex justify-between mb-4">
          <p className="text-right text-gray-500">חסכת</p>
